...
export type EmailJobName = 'send-welcome' | 'send-order-request' | 'send-order-accepted' | 'send-order-rejected' | 'send-payment-confirmation' | 'send-password-changed' | 'send-notification' | 'send-order-confirmation' | 'send-order-status-update' | 'send-payment-receipt' | 'send-reminder';
...
export type NotificationJobName = 'create-notification' | 'broadcast-system-alert';
...
export type PaymentJobName = 'process-payment' | 'refund-payment' | 'reconcile-payment';
...
export type MaintenanceJobName = 'expire-stale-orders' | 'send-pending-reminders' | 'process-pending-notifications' | 'reconcile-pending-payments';
