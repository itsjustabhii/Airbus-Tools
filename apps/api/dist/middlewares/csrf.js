 ...
 */
function setCsrfCookie(res, isProduction) {
...
function csrfProtection(req, res, next) {
    ...
    const cookieToken = req.cookies?.[exports.CSRF_COOKIE_NAME];
    const headerToken = req.headers[exports.CSRF_HEADER_NAME];
    ...
    try {
        ...
        if (cookieBuf.length !== headerBuf.length || !(0, crypto_1.timingSafeEqual)(cookieBuf, headerBuf)) {
